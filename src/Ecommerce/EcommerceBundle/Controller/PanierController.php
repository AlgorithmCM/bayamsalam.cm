...
class PanierController extends Controller {
    ...
    public function menuAction() {
        ...
        return $this->render('EcommerceBundle:Default:panier/modulesUsed/panierNbArticles.html.twig', array('articles' => $articles));
    }
    ...
    public function supprimerAction($id) {
        ...
        if (array_key_exists($id, $panier)) {
            ...
            $this->get('session')->getFlashBag()->add('success', 'Votre article a été supprimé avec succès');
        }
    ...
    public function ajouterAction($id) {
        ...
        if (array_key_exists($id, $panier)) {
            ...
            $this->get('session')->getFlashBag()->add('success', 'La quantité a été modifiée avec succès');
        }
        else {
            if ($this->getRequest()->query->get('qte') != null)
                $panier[$id] = $this->getRequest()->query->get('qte');
            ...
            $this->get('session')->getFlashBag()->add('success', 'Votre article a été ajouté avec succès');
        }
